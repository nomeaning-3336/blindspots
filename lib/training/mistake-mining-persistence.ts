 ...
 * Separated from the pure helpers so that tests can require mistake-mining.ts
 * without pulling in Supabase client dependencies.
 */
...
import {
  ...
  extractMineableMistakesFromSequence,
} from "./mistake-mining";
