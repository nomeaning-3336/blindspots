    ...
    sections: [
      {
        ...
        body: [
          ...
          "Blindspots are those small bumps of chess knowledge (or unfathomably large pits) that you keep failing over and over again in the same fashion.",
        ],
      },
      {
      ...
      },
      {
        ...
        body: [
          ...
          "But if you see the same exact position tomorrow, your memory cog starts spinning vigorously.",
      ...
      },
      {
        ...
        body: [
          ...
          "The fancy terms are retrieval practice and spaced repetition (ooohhh, now we are being scientific). Roediger and Karpicke showed that testing yourself can beat rereading for long-term retention. Ebbinghaus was poking at the forgetting curve before chess players were blaming lag or mouse slips for hanging queens.",
