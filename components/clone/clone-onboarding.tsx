...
export function CloneOnboarding({ screen, onSuccess, onError }: CloneOnboardingProps) {
  const [provider, setProvider] = useState<ChessProvider>("lichess");
        ...
        >
          ...
          <div className="flex flex-col gap-1">
            ...
            <input
              ...
              placeholder={
                provider === "lichess" ? "username" : "username"
              }
