...
- Name: train-replay-forward-sound-only.spec.ts >> ArrowLeft at position 0 does not crash and plays no sound
- Location: tests\e2e\train-replay-forward-sound-only.spec.ts:262:5
...
```ts
  ...
  2   | 
  3   | const E2E_USER_EMAIL = "joejen47u@gmail.com";
